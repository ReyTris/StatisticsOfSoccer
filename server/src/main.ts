...
import { IProjectService } from './projects/project.service.interface';
...
export const appBinding = new ContainerModule((bind: interfaces.Bind) => {
	...
	bind<IProjectController>(TYPES.IProjectController).to(ProjectController);
	bind<IProjectService>(TYPES.IProjectService).to(ProjectService);
